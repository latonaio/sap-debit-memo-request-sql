CREATE TABLE `sap_debit_memo_request_item_pricing_element_data`
(
  ...
  `ConditionIsManuallyChanged`     tinyint(1) DEFAULT NULL,
    PRIMARY KEY (`DebitMemoRequest`, `DebitMemoRequestItem`, `PricingProcedureStep`, `PricingProcedureCounter`),
    CONSTRAINT `SAPDebitMemoRequestItemPricingElementData_fk` FOREIGN KEY (`DebitMemoRequest`) REFERENCES `sap_debit_memo_request_header_data` (`DebitMemoRequest`)
) ENGINE = InnoDB
